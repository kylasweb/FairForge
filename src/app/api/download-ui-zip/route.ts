...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>UI Design Preview - Variation ${variation.variation} | DesignForge AI</title>
    <style>
        body {
            font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
            margin: 0;
...
<body>
    <div class="container">
        <div class="preview-header">
            ...
            <p style="color: #666; font-size: 0.9em; margin-bottom: 10px;">Generated by DesignForge AI</p>
